...
namespace XcyUI.expansions
{
    public static class ViewExtensions
    {
        ...
        public static XView GetColumnParent(this XView view)
        {
            if (view.Parent == null)
            {
                return null;
        ...
        public static XView GetWrapParent(this XView view)
        {
            if(view.Parent == null)
            {
                return null;
            ...
            if (view.Parent.LayoutParams.IsWrapWidth || view.Parent.LayoutParams.IsWrapHeight)
            {
                return GetWrapParent(view.Parent);
            }
            else
            {
                return null;
        ...
        internal static XView ClipParent(this XView view)
        {
            if (view.Parent == null)
            {
                return view;
            ...
            if (!view.Parent.Style.IsClipContent)
            {
                return GetWrapParent(view.Parent);
            }
            else
