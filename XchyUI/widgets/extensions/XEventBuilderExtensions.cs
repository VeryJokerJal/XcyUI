...
namespace XcyUI.widgets.extensions
{
    public static class XEventBuilderExtensions
    {
        ...
        public static XViewBuilder MeasureEnd(this XViewBuilder setter, XFunction<XViewBuilder> function)
        {
            ...
            {
                function.Invoke(new XViewBuilder(v, false));
            });
            return setter;
        }
        ...
        {
            builder.View.AddEvent(XEventType.LocationChanged, key, (v, info) => function(new XViewBuilder(v,false)));
            return builder;
        }       

        public static XViewBuilder KeyPress(this XViewBuilder builder, XFunction<XViewBuilder, XEventInfo> onKeyPress)
        {
            builder.AsView<XInput>()?.Also(n =>
            {
                n.AddEvent(XEventType.KeyPress, "KeyPress", (info) =>
                {
